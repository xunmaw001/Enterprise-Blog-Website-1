<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="介绍标题" prop="jieshaobiaoti">
          <el-input v-model="ruleForm.jieshaobiaoti" 
              placeholder="介绍标题" clearable  :readonly="ro.jieshaobiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="介绍标题" prop="jieshaobiaoti">
              <el-input v-model="ruleForm.jieshaobiaoti" 
                placeholder="介绍标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="介绍类型" prop="jieshaoleixing">
          <el-input v-model="ruleForm.jieshaoleixing" 
              placeholder="介绍类型" clearable  :readonly="ro.jieshaoleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="介绍类型" prop="jieshaoleixing">
              <el-input v-model="ruleForm.jieshaoleixing" 
                placeholder="介绍类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="介绍目标" prop="jieshaomubiao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="介绍目标"
                  v-model="ruleForm.jieshaomubiao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jieshaomubiao" label="介绍目标" prop="jieshaomubiao">
                    <span>{{ruleForm.jieshaomubiao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="具体介绍" prop="jutijieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jutijieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jutijieshao" label="具体介绍" prop="jutijieshao">
                    <span v-html="ruleForm.jutijieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="发展历程" prop="fazhanlicheng">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fazhanlicheng" label="发展历程" prop="fazhanlicheng">
                    <span v-html="ruleForm.fazhanlicheng"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jieshaobiaoti'){
            this.ruleForm.jieshaobiaoti = obj[o];
	    this.ro.jieshaobiaoti = true;
            continue;
          }
          if(o=='fengmian'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='jieshaoleixing'){
            this.ruleForm.jieshaoleixing = obj[o];
	    this.ro.jieshaoleixing = true;
            continue;
          }
          if(o=='jieshaomubiao'){
            this.ruleForm.jieshaomubiao = obj[o];
	    this.ro.jieshaomubiao = true;
            continue;
          }
          if(o=='fabushijian'){
	    ...
	    this.ro.chuanglishijian = true;
          ...
          if(o=='jutijieshao'){
            this.ruleForm.jutijieshao = obj[o];
	    this.ro.jutijieshao = true;
            continue;
          }
          if(o=='fazhanlicheng'){
	...
	this.ruleForm.jutijieshao = this.ruleForm.jutijieshao.replace(reg,'../../../ssmtok55/upload');
	this.ruleForm.fazhanlicheng = this.ruleForm.fazhanlicheng.replace(reg,'../../../ssmtok55/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qiyejieshao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qiyejieshaoCrossAddOrUpdateFlag = false;
                  this.parent.search();

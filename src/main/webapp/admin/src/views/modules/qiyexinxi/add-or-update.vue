  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chuanglishijian" label="创立时间" prop="chuanglishijian">
              <el-input v-model="ruleForm.chuanglishijian" 
                placeholder="创立时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="企业介绍" prop="qiyejieshao">
                <el-input
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssmtok55/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

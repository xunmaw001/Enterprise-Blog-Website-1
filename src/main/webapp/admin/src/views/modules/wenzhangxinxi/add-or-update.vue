<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属企业" prop="suoshuqiye">
          <el-input v-model="ruleForm.suoshuqiye" 
              placeholder="所属企业" clearable  :readonly="ro.suoshuqiye"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属企业" prop="suoshuqiye">
              <el-input v-model="ruleForm.suoshuqiye" 
                placeholder="所属企业" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuangongxingming = true;
          ...
          if(o=='suoshuqiye'){
            this.ruleForm.suoshuqiye = obj[o];
	    this.ro.suoshuqiye = true;
            continue;
          }
          if(o=='bumen'){
      ...
      this.$http({
		...
		if(json.suoshuqiye!=''&&json.suoshuqiye){
              		this.ruleForm.suoshuqiye = json.suoshuqiye
		}
		...
		if(json.zhiwei!=''&&json.zhiwei){
          ...
          this.$message.error(data.msg);
            ...
            this.wenzhangleixingOptions = "公司,生活,个人心情".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
	...
	this.ruleForm.wenzhangneirong = this.ruleForm.wenzhangneirong.replace(reg,'../../../ssmtok55/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

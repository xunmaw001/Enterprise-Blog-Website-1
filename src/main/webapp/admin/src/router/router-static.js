...
import center from '@/views/center'
    ...
    import qiyejieshao from '@/views/modules/qiyejieshao/list'
    import qiyexiangce from '@/views/modules/qiyexiangce/list'
    import qiyedongtai from '@/views/modules/qiyedongtai/list'
...
const routes = [{
	...
	path: '/qiyejieshao',
        name: '企业介绍',
        component: qiyejieshao
      }
      ,{
	path: '/qiyexiangce',
        name: '企业相册',
        component: qiyexiangce
      }
      ,{
	path: '/qiyedongtai',
        name: '企业动态',
        component: qiyedongtai
      }
      ,{

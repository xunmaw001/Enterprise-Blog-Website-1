<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="产品特点" prop="chanpintedian">
          <el-input v-model="ruleForm.chanpintedian" 
              placeholder="产品特点" clearable  :readonly="ro.chanpintedian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="产品特点" prop="chanpintedian">
              <el-input v-model="ruleForm.chanpintedian" 
                placeholder="产品特点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.chanpinxiangqing = this.ruleForm.chanpinxiangqing.replace(reg,'../../../ssmtok55/upload');
        } else {
          this.$message.error(data.msg);
        }
      });

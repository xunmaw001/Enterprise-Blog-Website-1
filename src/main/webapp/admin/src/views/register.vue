<template>
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(203, 203, 203, 1);borderRadius:10px">
        <h1 class="h1" style="color:rgba(255, 69, 0, 1);fontSize:25px;">企业博客网站注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210408/41c11e3bfd1e4fa8b9eee67f5c7e7fb4.jpg");
		height: 100vh;

<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="部门名" prop="bumenming">
          <el-select v-model="ruleForm.bumenming" placeholder="请选择部门名">
            <el-option
                v-for="(item,index) in bumenmingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="部门名" prop="bumenming">
	      <el-input v-model="ruleForm.bumenming"
                placeholder="部门名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmiantu = true;
          ...
          if(o=='bumenming'){
            this.ruleForm.bumenming = obj[o];
	    this.ro.bumenming = true;
            continue;
          }
          if(o=='jianshu'){
	...
	this.ruleForm.xiangcetupian = this.ruleForm.xiangcetupian.replace(reg,'../../../ssmtok55/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `qiyexiangce/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qiyexiangceCrossAddOrUpdateFlag = false;
                  this.parent.search();
